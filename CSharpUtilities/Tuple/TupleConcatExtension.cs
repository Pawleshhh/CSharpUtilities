...
public static partial class TupleExtension
{
    ...
    public static Tuple<T1, T2> Zip<T1, T2>(this Tuple<T1> tupleA, Tuple<T2> tupleB)
    {
        return new Tuple<T1, T2>(tupleA.Item1, tupleB.Item1);
    }

    public static ValueTuple<T1, T2> Zip<T1, T2>(this ValueTuple<T1> tupleA, ValueTuple<T2> tupleB)
    {
    ...
    public static Tuple<T1, T2, T3> Zip<T1, T2, T3>(this Tuple<T1, T2> tupleA, Tuple<T3> tupleB)
    {
        return new Tuple<T1, T2, T3>(tupleA.Item1, tupleA.Item2, tupleB.Item1);
    }

    public static Tuple<T1, T2, T3> Zip<T1, T2, T3>(this Tuple<T1> tupleA, Tuple<T2, T3> tupleB)
    {
        return new Tuple<T1, T2, T3>(tupleA.Item1, tupleB.Item1, tupleB.Item2);
    }

    public static ValueTuple<T1, T2, T3> Zip<T1, T2, T3>(this ValueTuple<T1, T2> tupleA, ValueTuple<T3> tupleB)
    {
        return new ValueTuple<T1, T2, T3>(tupleA.Item1, tupleA.Item2, tupleB.Item1);
    }

    public static ValueTuple<T1, T2, T3> Zip<T1, T2, T3>(this ValueTuple<T1> tupleA, ValueTuple<T2, T3> tupleB)
    {
    ...
    public static Tuple<T1, T2, T3, T4> Zip<T1, T2, T3, T4>(this Tuple<T1, T2> tupleA, Tuple<T3, T4> tupleB)
    {
        return new Tuple<T1, T2, T3, T4>(tupleA.Item1, tupleA.Item2, tupleB.Item1, tupleB.Item2);
    }

    public static Tuple<T1, T2, T3, T4> Zip<T1, T2, T3, T4>(this Tuple<T1, T2, T3> tupleA, Tuple<T4> tupleB)
    {
        return new Tuple<T1, T2, T3, T4>(tupleA.Item1, tupleA.Item2, tupleA.Item3, tupleB.Item1);
    }

    public static Tuple<T1, T2, T3, T4> Zip<T1, T2, T3, T4>(this Tuple<T1> tupleA, Tuple<T2, T3, T4> tupleB)
    {
        return new Tuple<T1, T2, T3, T4>(tupleA.Item1, tupleB.Item1, tupleB.Item2, tupleB.Item3);
    }

    public static ValueTuple<T1, T2, T3, T4> Zip<T1, T2, T3, T4>(this ValueTuple<T1, T2> tupleA, ValueTuple<T3, T4> tupleB)
    {
        return new ValueTuple<T1, T2, T3, T4>(tupleA.Item1, tupleA.Item2, tupleB.Item1, tupleB.Item2);
    }

    public static ValueTuple<T1, T2, T3, T4> Zip<T1, T2, T3, T4>(this ValueTuple<T1, T2, T3> tupleA, ValueTuple<T4> tupleB)
    {
        return new ValueTuple<T1, T2, T3, T4>(tupleA.Item1, tupleA.Item2, tupleA.Item3, tupleB.Item1);
    }

    public static ValueTuple<T1, T2, T3, T4> Zip<T1, T2, T3, T4>(this ValueTuple<T1> tupleA, ValueTuple<T2, T3, T4> tupleB)
    {
    ...
    public static Tuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this Tuple<T1, T2, T3, T4> tupleA, Tuple<T5> tupleB)
    {
        return new Tuple<T1, T2, T3, T4, T5>(tupleA.Item1, tupleA.Item2, tupleA.Item3, tupleA.Item4, tupleB.Item1);
    }

    public static Tuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this Tuple<T1, T2, T3> tupleA, Tuple<T4, T5> tupleB)
    {
        return new Tuple<T1, T2, T3, T4, T5>(tupleA.Item1, tupleA.Item2, tupleA.Item3, tupleB.Item1, tupleB.Item2);
    }

    public static Tuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this Tuple<T1, T2> tupleA, Tuple<T3, T4, T5> tupleB)
    {
        return new Tuple<T1, T2, T3, T4, T5>(tupleA.Item1, tupleA.Item2, tupleB.Item1, tupleB.Item2, tupleB.Item3);
    }

    public static Tuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this Tuple<T1> tupleA, Tuple<T2, T3, T4, T5> tupleB)
    {
        return new Tuple<T1, T2, T3, T4, T5>(tupleA.Item1, tupleB.Item1, tupleB.Item2, tupleB.Item3, tupleB.Item4);
    }

    public static ValueTuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this ValueTuple<T1, T2, T3, T4> tupleA, ValueTuple<T5> tupleB)
    {
        return new ValueTuple<T1, T2, T3, T4, T5>(tupleA.Item1, tupleA.Item2, tupleA.Item3, tupleA.Item4, tupleB.Item1);
    }

    public static ValueTuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this ValueTuple<T1, T2, T3> tupleA, ValueTuple<T4, T5> tupleB)
    {
        return new ValueTuple<T1, T2, T3, T4, T5>(tupleA.Item1, tupleA.Item2, tupleA.Item3, tupleB.Item1, tupleB.Item2);
    }

    public static ValueTuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this ValueTuple<T1, T2> tupleA, ValueTuple<T3, T4, T5> tupleB)
    {
        return new ValueTuple<T1, T2, T3, T4, T5>(tupleA.Item1, tupleA.Item2, tupleB.Item1, tupleB.Item2, tupleB.Item3);
    }

    public static ValueTuple<T1, T2, T3, T4, T5> Zip<T1, T2, T3, T4, T5>(this ValueTuple<T1> tupleA, ValueTuple<T2, T3, T4, T5> tupleB)
    {
    ...
    public static Tuple<T1, T2, T3, T4, T5, T6> Zip<T1, T2, T3, T4, T5, T6>(
    ...
    public static ValueTuple<T1, T2, T3, T4, T5, T6> Zip<T1, T2, T3, T4, T5, T6>(
    ...
    public static Tuple<T1, T2, T3, T4, T5, T6, T7> Zip<T1, T2, T3, T4, T5, T6, T7>(
    ...
    public static ValueTuple<T1, T2, T3, T4, T5, T6, T7> Zip<T1, T2, T3, T4, T5, T6, T7>(
